    ...
    return (
        <div className="max-w-4xl mx-auto pb-20">
            ...
            <article className="rounded-2xl border border-border bg-card overflow-hidden shadow-sm">
                <header className="p-8 md:p-12 border-b border-border bg-muted/5">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
                        <div className="p-4 rounded-xl bg-background border border-border">
                            ...
                            <p className="text-lg font-bold text-kr-up uppercase">{post.rating}</p>
                        </div>
                        <div className="p-4 rounded-xl bg-background border border-border">
                            <p className="text-[10px] text-muted-foreground uppercase mb-1">목표가</p>
                            <p className="text-lg font-bold">{post.targetPrice.toLocaleString()}원</p>
                        </div>
                        <div className="p-4 rounded-xl bg-background border border-border">
                            <p className="text-[10px] text-muted-foreground uppercase mb-1">현재가</p>
                            <p className="text-lg font-bold">{post.currentPrice.toLocaleString()}원</p>
                        </div>
                        <div className="p-4 rounded-xl bg-background border border-border">
                            <p className="text-[10px] text-muted-foreground uppercase mb-1">상승여력</p>
                            <p className="text-lg font-bold text-kr-up">{post.priceUpside}</p>
                        </div>
                    </div>
                ...
                <div className="p-8 md:p-12 prose prose-slate max-w-none prose-headings:font-bold prose-h1:text-2xl prose-h2:text-xl prose-p:leading-relaxed">
