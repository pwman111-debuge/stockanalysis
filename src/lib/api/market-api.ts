...
export interface MarketData {
    ...
    yieldSpreads?: MarketIndex[]; // 장단기 금리차 (10Y - 2Y)
    lastUpdated: string;
}
...
let cachedData: MarketData = {
    ...
    yieldSpreads: [
        { name: '미 장단기 금리차', value: '-0.270', change: '+0.025', percent: '', status: 'down' },
        { name: '한 장단기 금리차', value: '-0.040', change: '+0.005', percent: '', status: 'down' },
    ],
    supply: [
